...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/menu/actions/{actionId}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Menu action update data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateMenuActionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Menu action updated successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.MenuAction"
                                        }
                                    }
                                }
                            ]
                    ...
                    "404": {
                        "description": "Menu action not found",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Menu action deleted successfully",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
                    "400": {
                        "description": "Cannot delete action",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
        ...
        "/menu/user-tree": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User menu tree retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
        ...
        "/menu/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Cannot delete menu",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
        ...
        "/menu/{id}/actions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Menu actions retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Menu action creation data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Menu action created successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.RolePermission"
                                            }
                                        }
                                    }
                                }
        ...
        "/user-tenant-role/assign": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User tenant role assignment data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AssignUserTenantRoleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user-tenant-role/current": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Current user tenant roles retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.UserTenantRole"
                                            }
                                        }
                                    }
                                }
        ...
        "/user-tenant-role/remove": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User tenant role removal data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.RemoveUserTenantRoleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user-tenant-role/tenant/{tenantId}/role/{roleId}/users": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/user-tenant-role/user/{userId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User tenant roles retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
        ...
        "/user-tenant-role/user/{userId}/tenant/{tenantId}/roles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "domain.AssignUserTenantRoleRequest": {
            "type": "object",
            "required": [
                "tenant_roles",
                "user_id"
        ...
        "domain.CreateMenuActionRequest": {
            "type": "object",
            "required": [
                "code",
                "name",
        ...
        "domain.RemoveUserTenantRoleRequest": {
            "type": "object",
            "required": [
                "role_id",
                "tenant_id",
