    ...
    "paths": {
        ...
        "/settings/storage": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved storage configuration",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.StorageConfig"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully updated storage configuration",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
        ...
        "/settings/storage/test": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Unknown storage type or test failed",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    }
