...
import {Eye, Key, Plus, Shield, Trash2, UserPlus, Users} from 'lucide-react';
                                    ...
                                    <DialogContent>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <Select value={newRolePolicy.role}
                                                        onValueChange={(value) => setNewRolePolicy({
                                                            ...newRolePolicy,
                                                            role: value
                                                        })}>
                                                    <SelectTrigger>
                                            ...
                                            <div>
                                                ...
                                                <Select value={newRolePolicy.object}
                                                        onValueChange={(value) => setNewRolePolicy({
                                                            ...newRolePolicy,
                                                            object: value
                                                        })}>
                                            ...
                                            <div>
                                                ...
                                                <Select value={newRolePolicy.action}
                                                        onValueChange={(value) => setNewRolePolicy({
                                                            ...newRolePolicy,
                                                            action: value
                                                        })}>
                                                    ...
                                                    <SelectContent>
                                                        {actions.map(action => (
                                                            <SelectItem key={action}
                                                                        value={action}>{action}</SelectItem>
                                                        ))}
                                                    </SelectContent>
                                                </Select>
                                            </div>
                                            <div className="flex gap-2">
                                                ...
                                                <Button variant="outline"
                                                        onClick={() => setShowAddRolePolicyDialog(false)}
                                ...
                                <Dialog open={showAddUserRoleDialog} onOpenChange={setShowAddUserRoleDialog}>
                                    ...
                                    <DialogContent>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <Label htmlFor="role">角色</Label>
                                                <Select value={newUserRole.role}
                                                        onValueChange={(value) => setNewUserRole({
                                                            ...newUserRole,
                                                            role: value
                                                        })}>
                                                    <SelectTrigger>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <Button variant="outline"
                                                        onClick={() => setShowAddUserRoleDialog(false)}
                                                        className="flex-1">取消</Button>
                                            </div>
                                        </div>
                                    </DialogContent>
                                ...
                                <Dialog open={showAddUserPolicyDialog} onOpenChange={setShowAddUserPolicyDialog}>
                                    ...
                                    <DialogContent>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <Label htmlFor="object">对象</Label>
                                                <Select value={newUserPolicy.object}
                                                        onValueChange={(value) => setNewUserPolicy({
                                                            ...newUserPolicy,
                                                            object: value
                                                        })}>
                                                    <SelectTrigger>
                                            ...
                                            <div>
                                                <Label htmlFor="action">操作</Label>
                                                <Select value={newUserPolicy.action}
                                                        onValueChange={(value) => setNewUserPolicy({
                                                            ...newUserPolicy,
                                                            action: value
                                                        })}>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <Button variant="outline"
                                                        onClick={() => setShowAddUserPolicyDialog(false)}
                                                        className="flex-1">取消</Button>
                                            </div>
                                        </div>
                                    </DialogContent>
